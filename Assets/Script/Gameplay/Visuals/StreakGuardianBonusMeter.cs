...
{
    public class StreakGuardianBonusMeter : MonoBehaviour
    {
        ...
        private const string STREAK_GUARDIAN_COLOR_PROPERTY = "_StreakGuardianColor";
        ...
        private void Awake()
        {
            _meshRenderer.material.SetColor(STREAK_GUARDIAN_COLOR_PROPERTY, _color);
